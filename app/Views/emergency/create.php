<?php
// app/Views/emergency/create.php - Página de cadastro de contato de emergência
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Adicione uma pessoa de confiança que pode ser contatada em situações de emergência
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden mb-8">
            <div class="bg-gradient-to-r from-red-50 to-red-100 px-8 py-6 border-b border-red-200">
                <h2 class="text-2xl font-bold text-gray-900">Informações do Contato</h2>
                <p class="text-sm text-gray-600 mt-1">Preencha os dados da pessoa de confiança</p>
            </div>

            <form method="POST" action="/emergency/create" class="p-8 space-y-6">
                <!-- Nome do Contato -->
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <option value="Família" <?= (($_POST['contact_relationship'] ?? '') === 'Família') ? 'selected' : '' ?>>Família</option>
                            <option value="Amigo(a)" <?= (($_POST['contact_relationship'] ?? '') === 'Amigo(a)') ? 'selected' : '' ?>>Amigo(a)</option>
                            <option value="Cônjuge" <?= (($_POST['contact_relationship'] ?? '') === 'Cônjuge') ? 'selected' : '' ?>>Cônjuge</option>
                            <option value="Pai/Mãe" <?= (($_POST['contact_relationship'] ?? '') === 'Pai/Mãe') ? 'selected' : '' ?>>Pai/Mãe</option>
                            <option value="Irmão(ã)" <?= (($_POST['contact_relationship'] ?? '') === 'Irmão(ã)') ? 'selected' : '' ?>>Irmão(ã)</option>
                            <option value="Outro" <?= (($_POST['contact_relationship'] ?? '') === 'Outro') ? 'selected' : '' ?>>Outro</option>
                        </select>
                ...
                <div class="space-y-2">
                    <div class="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <input 
                            ...
                            <?= isset($_POST['is_primary']) ? 'checked' : '' ?>
                        >
                        <div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-2xl shadow-lg p-8">
            <div class="flex gap-4">
                ...
                <div class="flex-1">
                    <h3 class="text-xl font-bold text-blue-900 mb-3">Dicas para Escolher Contatos de Emergência</h3>
                    <ul class="space-y-2 text-blue-800">
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="leading-relaxed">Escolha pessoas que você confia e que podem te ajudar em situações difíceis</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="leading-relaxed">Certifique-se de que a pessoa está ciente de que pode ser contatada</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                            </svg>
                            <span class="leading-relaxed">Verifique se o número de telefone está correto e atualizado</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <svg class="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>

    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 tracking-tight">Editar Artigo</h1>
                    <p class="text-gray-600 mt-1">Atualize as informações do artigo</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-gray-50 to-white px-8 py-6 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600 mt-1">Atualize os campos necessários</p>
            </div>

            <form action="/admin/articles/<?= $article['id'] ?>/update" method="POST" class="p-8 space-y-8">
                <!-- Título -->
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="excerpt" id="excerpt"
                              ...
                              rows="3"
                              placeholder="Breve descrição do artigo que aparecerá na listagem..."><?= htmlspecialchars($article['excerpt'] ?? '') ?></textarea>
                </div>
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div class="flex gap-3">
                ...
                <div class="flex-1">
                    <h3 class="font-semibold text-blue-900 mb-2">Informações do Artigo</h3>
                    <div class="text-sm text-blue-800 space-y-1">
                        <p>Criado em: <?= date('d/m/Y H:i', strtotime($article['created_at'])) ?></p>
                        <p>Última atualização: <?= date('d/m/Y H:i', strtotime($article['updated_at'])) ?></p>
                    </div>
                </div>
            </div>
        </div>
